...
public struct Bushel {

  public static func start () throws  -> VZVirtualMachine {

     let readPipe = Pipe()
     let writePipe = Pipe()

    let kernelURL = URL(fileURLWithPath: "/Users/leo/Downloads/vmlinuz")
    ...
    try! harddrive.close()
    let initialRamdiskURL = URL(fileURLWithPath: "/Users/leo/Downloads/initrd.gz")
