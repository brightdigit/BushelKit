...
public protocol SnapshotterFactory: LoggerCategorized {
  ...
  func createNewSnapshot(of machine: some Machine, request: SnapshotRequest, options: SnapshotOptions) async throws -> Snapshot
  func snapshotter<MachineType: Machine>(supports: MachineType.Type) -> (any Snapshotter<MachineType>)?
}

extension SnapshotterFactory {
  public static var loggingCategory: LoggersType.LoggerCategory {
    .machine
  }
