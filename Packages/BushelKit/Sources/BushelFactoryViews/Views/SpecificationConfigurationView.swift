...
//
  ...
  struct SpecificationConfigurationView: View, Sendable {
    ...
    @Binding var configuration: SpecificationConfiguration
    ...
    var body: some View {
      Form {
        ...
        SliderStepperView(
          ...
          bounds: SpecificationConfiguration.fullStorageBoundsRange
        ) { _ in
          Text(
    ...
    internal init(isNextReady: Binding<Bool>, configuration: Binding<SpecificationConfiguration>) {
