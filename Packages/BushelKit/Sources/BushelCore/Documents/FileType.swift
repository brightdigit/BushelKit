...
public extension FileType {
  ...
  static let virtualMachineFileExtension = "bshvm"
  static let restoreImageLibraryFileExtension = "bshrilib"

  static let virtualMachine: FileType = .exportedAs(
    "com.brightdigit.bushel-vm",
    virtualMachineFileExtension
  )

  static let restoreImageLibrary: FileType = .exportedAs(
