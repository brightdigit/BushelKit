...
extension OperatingSystemVersion: CustomStringConvertible,
  ...
  public init(compositeFrom decoder: any Decoder) throws {
  ...
  public init(container: any SingleValueDecodingContainer) throws {
    let value = try container.decode(String.self)
    try self.init(string: value)
  }

  public init(stringFrom decoder: any Decoder) throws {
